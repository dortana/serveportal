  ...
  return (
    <div className='p-4 rounded-lg h-full'>
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
        <div className='bg-white h-auto flex-1 rounded-lg p-5 space-y-5'>
          ...
          <div className='flex justify-between items-center'>
            ...
            >
              <path
                d='M10.5 1.75C12.8211 1.75 14.7064 3.61072 14.748 5.92188H6.25195C6.29363 3.61072 8.17889 1.75 10.5 1.75Z'
                fill='currentColor'
              ></path>
              <path
                opacity='0.4'
                d='M5.44629 4.58203C5.63541 3.9064 5.95579 3.28609 6.37891 2.75H5.16211C3.5541 2.75 2.25017 3.98137 2.25 5.5V15.5645C2.24997 16.9274 2.24998 18.0267 2.36621 18.8916C2.48722 19.7916 2.74681 20.5495 3.34863 21.1514C3.93114 21.6762 4.76457 22.0203 5.6084 22.1338C6.47331 22.2501 7.57249 22.25 8.93555 22.25H15.0645C16.4275 22.25 17.5267 22.2501 18.3916 22.1338C19.2917 22.0128 20.1588 21.639 20.7607 21.0371C21.2855 20.4546 21.5203 19.7354 21.6338 18.8916C21.6976 18.4167 21.7243 17.871 21.7373 17.25H19C18.6354 17.25 18.1995 17.2273 17.918 17.1729C17.19 16.9777 16.6109 16.4329 16.3701 15.7256C16.2871 15.4154 16.25 14.9165 16.25 14.5C16.25 14.0834 16.2871 13.5845 16.3701 13.2744C16.611 12.5672 17.19 12.0222 17.918 11.8271C18.1995 11.7727 18.6354 11.75 19 11.75H21.7373C21.7243 11.129 21.6976 10.5833 21.6338 10.1084C21.5203 9.26466 21.2855 8.54535 20.7607 7.96289C20.2403 7.44248 19.4938 7.06409 18.749 6.92383C18.7475 6.4243 18.7376 6.01686 18.6641 5.65723L18.6172 5.46777C18.2806 4.2817 17.3402 3.33885 16.1201 2.94629L15.8721 2.875C15.5119 2.78391 15.1114 2.76059 14.624 2.75391C15.0804 3.33324 15.4161 4.01087 15.5967 4.75C16.2256 5.02445 16.6852 5.6099 16.7803 6.31543C16.7979 6.44627 16.7979 6.60209 16.7979 6.90931V6.92285H5.36133C4.71516 6.92259 4.19141 6.39819 4.19141 5.75195C4.19176 5.10602 4.71537 4.5823 5.36133 4.58203H5.44629Z'
                fill='currentColor'
              ></path>
              <path
                d='M21.75 15.75H19C18.6148 15.75 18.3721 15.7363 18.3721 15.7363C18.1575 15.7499 17.7754 15.4498 17.7754 15.1943C17.7753 15.1205 17.75 15.0128 17.75 14.5C17.75 13.9869 17.7563 13.877 17.7754 13.8057C17.7756 13.6013 18.129 13.2638 18.3721 13.2637C18.457 13.2538 18.6148 13.25 19 13.25H21.75V15.75Z'
                fill='currentColor'
              ></path>
            </svg>
            <h2 className='text-xl lg:text-2xl font-bold'>0.00 </h2>
          </div>
        </div>
        <div className='bg-white h-auto flex-1 rounded-lg p-5 space-y-5'>
        ...
        <div className='bg-white h-auto flex-1 rounded-lg p-5 space-y-5'>
          <h2 className='text-lg font-semibold'>{t('Open Tickets')}</h2>
          <div className='flex justify-between items-center'>
            <svg
              className='lg:size-14'
              xmlns='http://www.w3.org/2000/svg'
