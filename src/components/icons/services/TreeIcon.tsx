...
const TreeIcon = ({ className }: { className?: string }) => {
  return (
    ...
    >
      <path
        opacity='0.4'
        d='M5.25 8C5.25 4.27208 8.27208 1.25 12 1.25C15.7279 1.25 18.75 4.27208 18.75 8V12C18.75 15.7279 15.7279 18.75 12 18.75C8.27208 18.75 5.25 15.7279 5.25 12V8Z'
        fill='currentColor'
      ></path>
      <path
